...
__author__ = 'Joseph Louwrens Raspel'
__copyright__ = 'Copyright (C) 2022, Joseph Louwrens Raspel'
__credits__ = ['Joseph Louwrens Raspel']
__license__ = 'The MIT License (MIT)'
__version__ = '1.0'
__maintainer__ = 'Joseph Louwrens Raspel'
__email__ = 'Joe@raspel.co.za'
__status__ = 'Beta'

_AppName_ = 'ZestfruitUpdaterUtility'
